...
| Library tab | everything in `resources/` - the playbooks, fundamentals, copywriting guides, and case studies (read-only render; new .md files there appear automatically) |
