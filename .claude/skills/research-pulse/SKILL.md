...
3. **File the raw.** Append findings to the matching `research/raw/<source>/` folder as `DD-MM-YYYY_<topic>.md` files - quotes verbatim, a link on everything. Raw is never rewritten, only added to.
