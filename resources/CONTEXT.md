...
The shared knowledge every skill and every brand pulls from. Nothing in here is brand-specific - brand knowledge lives in `brands/<brand>/`.

## The map of this zone

| Where | What | Pull it when |
|-------|------|--------------|
...
| `marketing-fundamentals/` | The foundation library, six guides: how ads work, buyer psychology, scroll psychology, metrics & diagnosis, research methods, operator mindset | Starting out · needing the big picture · reading the ad account · stuck on research · motivation dips |
...
| `copywriting/` | The writing craft, six guides: script principles (educate before the product), hooks (the first 3-5s), retention (holding them after), writing for your avatar (style follows the person), spoken voice (write for the mouth - the tells table + read-aloud test), text on screen (writing for the inner voice) | Writing or reviewing any copy · hook variations · hold-rate leaks · tone feels off · a script dies read aloud |
...
These are living docs. When a learning changes how we work (not just what we know about one brand), the playbook gets updated in the same action - that is the close-the-loop behavior from the root CLAUDE.md applied here.
